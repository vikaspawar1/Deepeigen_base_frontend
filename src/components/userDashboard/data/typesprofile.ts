...
export const fetchProfileData = async (): Promise<ApiResponse> => {
  ...
  const addressParts = [
    ...
    backend.postal_code || addressObj.postal_code || backend.zip_code || addressObj.zip_code || "",
  ];
    ...
    data: {
      profile: {
        ...
        profilePicture: backend.profile_picture
          ? `${api.defaults.baseURL}${backend.profile_picture}`
          : null,
...
export const updateProfile = async (
  ...
  if (profileData.address) {
    ...
    payload.address_line_1 = parts[0] || "";
    payload.address_line_2 = parts[1] || "";
    payload.city = parts[2] || "";
    payload.state = parts[3] || "";
    payload.country = parts[4] || "";
    payload.postal_code = parts[5] || "";
  }
